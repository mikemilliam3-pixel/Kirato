...
const Home: React.FC = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-8 py-6 md:py-12 lg:py-16 animate-in fade-in duration-500">
      <div className="mb-8 md:mb-16 text-left">
        ...
        <p className="text-[11px] sm:text-sm md:text-base font-bold text-slate-400 dark:text-slate-500 max-w-2xl uppercase tracking-widest leading-relaxed">
          {t('homeSubtitle')}
        </p>
      </div>
      ...
      <div className="fixed top-1/4 -left-40 w-80 h-80 bg-purple-50/5 rounded-full blur-[100px] pointer-events-none -z-10" />
    </div>
  );
};
